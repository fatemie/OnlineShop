...
class SearchAdapter(var onProductClicked: ItemClickHandler) :
    ListAdapter<ProductsApiResultItem, SearchAdapter.ViewHolder>(SearchDiffCallback) {
...
object SearchDiffCallback : DiffUtil.ItemCallback<ProductsApiResultItem>() {
